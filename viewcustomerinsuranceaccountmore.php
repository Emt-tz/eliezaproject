...
$installmentno = 1;
				...
				?>
                    ...
                    ?>	
                      ...
                      <?php
					  		//###############
							$sqlrecpolicy_payment = "SELECT * FROM policy_payment where insurance_account_id='$_GET[insacid]' ";
							$qsqlrecpolicy_payment = mysqli_query($con,$sqlrecpolicy_payment);
								$rspolicy_payment = mysqli_fetch_array($qsqlrecpolicy_payment);
							if(mysqli_num_rows($qsqlrecpolicy_payment) >= $installmentno )
							{
							...
							else
							{
								if($paynext == "")
								{	
									if(mysqli_num_rows($qsqlrecpolicy_withdrawal) == 0)
									{
