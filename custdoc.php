...
if($_SESSION['randomid']==$_POST['randomid'])
{
	if(isset($_POST['submit']))
	{
		...
		$sqlrec = "INSERT INTO customer_document (customer_id,document_type,document_path) VALUES ('$_SESSION[customer_id]','$_POST[dtype]','$filename')";
		$qsqlrec = mysqli_query($con,$sqlrec);
		if(mysqli_affected_rows($con) == 1 )
		{
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="dtype" class="form-control">
                                    ...
                                    <?php
$arr = array("car card","Voter ID","police document");
foreach($arr as $val)
{
	echo "<option value='$val'>$val</option>";
}
?>
                                </select></br><span id="iddtype"></span>
                            </td>
                        </tr>
                        <div class="cleaner_h10"></div>

                        <tr>
                            <th> <label for="Password">Document:</label></th>
                    ...
                    <table border="1" id="example" class="table table-striped table-bordered" cellspacing="0"
                        ...
                        <tbody>
                            <?php
			 	$sqlrec = "SELECT * FROM customer_document  WHERE customer_id='$_SESSION[customer_id]'";
				$qsqlrec = mysqli_query($con,$sqlrec);
