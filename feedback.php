...
if($_SESSION['randomid']==$_POST['randomid'])
{
	if(isset($_POST['submit']))
	{
		...
		{
			$sqlrec="UPDATE contact SET customer_id='$_POST[customer]',title='$_POST[title]',message='$_POST[description]',contact_date='$_POST[cdate]',reply='$_POST[reply]' WHERE contact_id='$_GET[editid]'";
		...
		{
			$sqlrec="INSERT INTO contact(customer_id,title,message,contact_date)   VALUES ('$_SESSION[customer_id]','$_POST[title]','$_POST[description]','$dt') ";		
			$qsqlrec = mysqli_query($con,$sqlrec);
			if(mysqli_affected_rows($con) == 1 )
			{
