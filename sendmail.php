...
{
	$loginid 	= "einsurance@myprojectcoding.xyz";
	$password 	= "nO&K%t&icahP";
	$smtpserver = "mail.myprojectcoding.xyz";
	$smtpport 	= 26;
	$mailsender = "einsurance";
	$companyname= "einsurance";
	$facebook = "https://www.facebook.com/einsurance";
	$twitter = "https://www.twitter.com/einsurance";
	$youtube = "https://www.youtube.com/einsurance";
	$linkedin = "https://www.linkedin.com/einsurance";
	$companyaddress  = "einsurance, 9-57, Wadi-e-Hadees, Hyderabad-500005, India | Email us: hyd2050@gmail.com";
	$contactno = "+91-9550313048";
	$url = "www.einsurance.in";
...
//sendmail("studentprojects.live@gmail.com", "Aravinda" , "My subject title", "My message");
?>