...
{
	$sqlrec = "INSERT INTO agent (agent_name,agent_code,password,agent_address,status) VALUES ('$_POST[aname]','$_POST[acode]','$_POST[password]','$_POST[aaddress]','$_POST[status]')";
