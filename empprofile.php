...
if($_SESSION['randomid']==$_POST['randomid'])
{
	...
	{
		$sqlrec = "UPDATE employee SET emp_type='$_POST[etype]',emp_name='$_POST[ename]',login_id='$_POST[loginid]',status='$_POST[status]' WHERE employee_id='$_SESSION[employee_id]'";
...
{
	$sqlrecedit = "SELECT * FROM employee WHERE employee_id='$_SESSION[employee_id]'";
...
<p class="lead">update Employee Profile...</p>
</div> 
