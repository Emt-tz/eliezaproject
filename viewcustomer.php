        ...
        <div class="container">
            ...
            <div class="row contact-wrap"> 
              ...
              <thead>
               ...
               <?php
				$sqlrec = "SELECT * FROM customer where customer_id != '' ";
				...
				while($rs = mysqli_fetch_array($qsqlrec))
				{
					...
					$sqlreccity="SELECT * FROM city where city_id='$rs[city_id]'";
					$qsqlreccity = mysqli_query($con,$sqlreccity);
					$rscity = mysqli_fetch_array($qsqlreccity);
                	...
                	echo " <tr>
						  ...
						  <td>&nbsp;$rs[status]</td>
							 <td>&nbsp;<a href='viewcustdocu.php?custdocid=$rs[customer_id]' class='btn btn-warning'>View Documents</a></td>";
								if(isset($_SESSION['employee_id']))
								{
							  echo " <td><a href='customer.php?editid=$rs[customer_id]' class='btn btn-info' style='width: 100%;' class='btn btn-info' >Edit</a><a href='viewcustomer.php?delid=$rs[customer_id]' onclick='return deleteconfirm()' class='btn btn-danger' style='width: 100%;' class='btn btn-danger' >Delete</a></td>";
								}
						echo "</tr>";
				}
				?>
