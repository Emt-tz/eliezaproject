...
//if($_SESSION['randomid']==$_POST['randomid'])
{
	...
	if(isset($_POST['submit']))
	{
				...
				{
						$sqlrec =  "UPDATE policy_withdrawal SET particulars='$_POST[particulars]',claim_status='$_POST[claimstatus]' WHERE insurance_account_id='$_GET[insacid]'";
				...
				{
						 $sqlrec = "INSERT INTO policy_withdrawal (insurance_account_id,claim_amt,claim_date,bank_name,bank_ac_no, branch, branch_code,claim_status) VALUES ('$_POST[insuranceaccid]','$_POST[sumassured]','$dt','$_POST[bname]','$_POST[baccno]','$_POST[branch]','$_POST[bcode]','Pending')";
						$qsqlrec = mysqli_query($con,$sqlrec);
						if(mysqli_affected_rows($con) == 1 )
						{
	...
	$sqlrecinsurance_account = "SELECT * FROM insurance_account where status='Active' AND insurance_account_id='$_GET[insacid]'";
	...
	$sqlrecpolicy_withdrawal = "SELECT * FROM policy_withdrawal WHERE insurance_account_id='$_GET[insacid]'";
	$qsqlrecpolicy_withdrawal = mysqli_query($con,$sqlrecpolicy_withdrawal);
	$rspolicy_withdrawal = mysqli_fetch_array($qsqlrecpolicy_withdrawal);
?>
...
<div align="center" >
             ...
             <table  border="1" class="table table-striped table-bordered" cellspacing="0" width="100%">
               <thead>
                ...
                <tbody>
             <?php
			 $sqlreccust="SELECT * FROM customer where customer_id='$rsinsurance_account[customer_id]'";
              ...
              <table  border="1" class="table table-striped table-bordered" cellspacing="0" width="100%">
               <thead>
                ...
                <?php
					...
					$sqlrecinsurplan = "SELECT * FROM insurance_plan WHERE insurance_plan_id='$rsinsurance_account[insurance_plan_id]'";
              ...
              <table  border="1" class="table table-striped table-bordered" cellspacing="0" width="100%">
               <thead>
                ...
                <?php
					...
					$sqlrecpolicy_payment = "SELECT SUM(paid_amt) FROM policy_payment WHERE insurance_account_id='$_GET[insacid]'";
...
?>
              ...
              <table  border="1" class="table table-striped table-bordered" cellspacing="0" width="100%">
               <thead>
                ...
                <tbody>
                <?php
				$sqlrec = "SELECT * FROM insurance_account where status='Active' AND insurance_account_id='$_GET[insacid]'";
				$qsqlrec = mysqli_query($con,$sqlrec);
...
<?php
if(mysqli_num_rows($qsqlrecpolicy_withdrawal) >=1)
{
?> 
