...
if(isset($_POST['submit']))
{
	...
	{
	$sqlrec =  "UPDATE policy_withdrawal SET insurance_account_id='$_POST[iacc]' ,withdrawal_amt='$_POST[wamt]', withdrawal_date='$_POST[wdate]',bank_name='$_POST[bname]',bank_ac_no='$_POST[baccno]',branch='$_POST[branch]',branch_code='$_POST[bcode]',withdraw_status='$_POST[status]' WHERE policy_withdrawal_id='$_GET[editid]'";
	...
	{
		$sqlrec = "INSERT INTO policy_withdrawal (insurance_account_id,withdrawal_amt,withdrawal_date,bank_name,bank_ac_no, branch, branch_code,withdraw_status) VALUES ('$_POST[iacc]','$_POST[wamt]','$_POST[wdate]','$_POST[bname]','$_POST[baccno]','$_POST[branch]','$_POST[bcode]','$_POST[status]')";
		$qsqlrec = mysqli_query($con,$sqlrec);
		if(mysqli_affected_rows($con) == 1 )
		{
...
if(isset($_GET['editid']))
{
	$sqlrecedit = "SELECT * FROM policy_withdrawal WHERE policy_withdrawal_id='$_GET[editid]'";
...
<form method="post" name="contact" action="">
                    ...
                    <label for="Password">Insurance Account:</label> <select name="iacc" >
                     ...
                     <option value="">Select</option>
                          <?php
						$sqlrecpp = "SELECT * FROM insurance_account";
