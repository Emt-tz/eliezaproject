    ...
    <div class="container">
        ...
        <div class="center">
            ...
            <div align="center">
                ...
                <form id="main-contact-form" class="contact-form" method="get" action="insuracc.php"
                    name="frminsurdetail" onsubmit="return validateform()">
                    <table border="1" id="example" class="table table-striped table-bordered" cellspacing="0">
                        <caption><strong>
                                <font size="+2" color="#000000">Plan Details:</font>
                            </strong></caption>
                        <tr>
                            <th width="182">
                                <p><strong>Policy term - minimum :</strong>
                            </th>
                            <td width="167"><?php echo $rsedit1['policy_term_min']; ?> years
                                <input type="hidden" name="policy_term_min"
                                    value="<?php echo $rsedit1['policy_term_min']; ?>" /></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
                                <p><strong>Policy term - Maximum : </strong>
                            </th>
                            <td><?php echo $rsedit1['policy_term_max']; ?> years
                                <input type="hidden" name="policy_term_max"
                                    value="<?php echo $rsedit1['policy_term_max']; ?>" /></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td><?php echo $rsedit1['min_age']; ?>
                                <input type="hidden" name="min_age" value="<?php echo $rsedit1['min_age']; ?>" /></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td><?php echo $rsedit1['max_age']; ?>
                                <input type="hidden" name="max_age" value="<?php echo $rsedit1['max_age']; ?>" /></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
                                <p><strong> Minimum Investment amount: </strong>
                            </th>
                            <td> Rs. <?php echo $rsedit1['sum_assured_min']; ?>
                                <input type="hidden" name="sum_assured_min"
                                    value="<?php echo $rsedit1['sum_assured_min']; ?>" /></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
                                <p><strong>Maximum Investment amount: </strong>
                            </th>
                            <td>Rs. <?php echo $rsedit1['sum_assured_max']; ?>
                                <input type="hidden" name="sum_assured_max"
                                    value="<?php echo $rsedit1['sum_assured_max']; ?>" /></p>
                            </td>
                        </tr>
                        <tr>
                            <th>
                                <p><strong>Profit Ratio : </strong>
                            </th>
                            <td><?php echo $rsedit1['profit_ratio']; ?>%</p>
                            </td>
                        </tr>
                        </br></br>
                    </table>
        ...
        <div class="row contact-wrap">
            ...
            <div align="center">
                ...
                <input name="percentage" id="percentage" type="hidden"
                    value="<?php echo $rsedit1['profit_ratio']; ?>" />
                <?php
		...
		?>
                <table border="1" id="example" class="table table-striped table-bordered" cellspacing="0">
                    ...
                    <tr>
                        <td width="144">
                            <div align="left"><label>No. of years:</label></div>
                        </td>
                        <td width="153"><input type="number" class="form-control" required name="nyear" id="nyear"
                                min="<?php echo $rsedit1['policy_term_min']; ?>"
                                max="<?php echo $rsedit1['policy_term_max']; ?>" /><span id="errnyear"></span></td>
                    </tr>

                    <tr>
                        <td>
                            <div align="left"><label>Total Investment Amount:</label></div>
                        </td>
                        <td><input type="text" class="form-control" required name="invstamt" id="invstamt" /><span
                                id="errninvstamt"></span></td>
                    </tr>

                    <tr>
                        <td>
                            <div align="left"><label>Months:</label></div>
                        </td>
            ...
            ?>
                    ...
                    <tr>
                        <td colspan="2">
                            <div align="center"> <button type="button" value="Calculate" id="submit2" name="submit2"
                                    class="btn btn-primary btn-lg" onclick="calculateinterest()">Calculate</button>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <div align="left"><label>Installment Amount:</label></div>
                        </td>
                        <td><input type="text" class="form-control" required name="instllamt" id="instllamt" readonly />
                        </td>
                        <div class="cleaner_h10"></div>
                    </tr>
                    <tr>
                        <td>
                            <div align="left"><label>Interest Amount:</label></div>
                        </td>
                        <td><input type="text" class="form-control" required name="inttamt" id="inttamt" readonly />
                        </td>
                    </tr>

                    <tr>
                        <td>
                            <div align="left"></div><label>Total Amount:</label>
            </div>
            </td>
            ...
            <tr>
                <td colspan="2">
                    <div align="center"><button type="submit" name="submit"
		...
		else
		{
            ...
            ?>
                ...
                <tr>
                    <td colspan="2">
                        <div align="center"> <button type="button" value="Calculate" id="submit2" name="submit2"
                                class="btn btn-primary btn-lg" onclick="calculateinterest()">Calculate</button></div>
                    </td>
                </tr>
