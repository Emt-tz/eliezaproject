               ...
               <thead>
				...
				while($rs = mysqli_fetch_array($qsqlrec))
				{
                	...
                	echo " <tr>
						  ...
						  <td>&nbsp;$rs[status]</td>
						  <td>&nbsp;<a href='insurscheme.php?editid=$rs[insurance_scheme_id]' class='btn btn-info' >Edit</a> |  <a href='viewinsurscheme.php?delid=$rs[insurance_scheme_id]' onclick='return deleteconfirm()' class='btn btn-danger' >Delete</a></td>
						</tr>";
				}
				?>
              </table>
