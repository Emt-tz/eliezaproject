...
if($_SESSION['randomid'] == $_POST['randomid'])
{
	...
	{
		$sqlrec = "UPDATE agent SET agent_name='$_POST[aname]',agent_code='$_POST[acode]',agent_address='$_POST[aaddress]',email_id='$_POST[email]',Qualification='$_POST[qualification]'  WHERE agent_id = '$_SESSION[agent_id]'";
...
{
	$sqlrecedit = "SELECT * FROM agent WHERE agent_id='$_SESSION[agent_id]'";
