...
{
	$sqlrec = "UPDATE agent SET status='Active' WHERE agent_id='$_GET[agentid]' ";
...
if(isset($_POST['submit']))
{
		...
		$pwd = $_POST['password'];
	$sqlrec = "SELECT * FROM agent WHERE agent_code='$_POST[agent_code]'  && password='$pwd'";
	$var=mysqli_query($con,$sqlrec);
                ...
                <form id="main-contact-form" class="contact-form" method="post" name="contact" action="">
                    ...
                    <div align="center">
                        <table id="example" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tr>
                                <th><label for="author">Agent Code:</label></th>
                                <td> <input type="text" name="agent_code" class="form-control" required /></td>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div align="center"><input type="submit" value="Login.." id="submit" name="submit"
                            ...
                            <tr>
                                <td colspan="2">
                                    <div align="center"><strong>Did you forgot password?</strong><br /><input
                                            type="button" onclick="window.location='agentforgotpassword.php';"
                                            value="Click here to Recover Password.." id="submit" name="submit"
                                            class="btn btn-primary btn-lg" /></div>
                                </td>
                            </tr>
                        </table>
