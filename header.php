...
.social{<h1style="font-size:60px;" > ONLINE INSURANCE MANAGEMENT SYSTEM</h1>
}
    ...
    <header id="header">
        <div class="top-bar">
            <div class="container">
                <div class="row">
                    <div class="col-sm-6">
                        <h5 style="color: white">ONLINE INSURANCE MANAGEMENT SYSTEM</h5>
                    </div>
...
if (isset($_SESSION['employee_id'])) {
    $sqlrecemployeeac = "SELECT * FROM employee WHERE employee_id='$_SESSION[employee_id]'";
    $varemployeeac = mysqli_query($con, $sqlrecemployeeac);
...
if (isset($_SESSION['agent_id'])) {
    $sqlrecagentac = "SELECT * FROM agent WHERE agent_id='$_SESSION[agent_id]'";
    $varagentac = mysqli_query($con, $sqlrecagentac);
...
if (isset($_SESSION['customer_id'])) {
    ?>
                        ...
                        <li class="dropdown"> <a href="#">Customer Profile<i class="fa fa-angle-down"></i></a>
                          ...
                          <li class="dropdown">
                            <a href="insurschemeinfo.php"> VIEW INSURANCE INFORMATION<i class="fa fa-angle-down"></i></a>
                             <ul class="dropdown-menu"> 
    ...
    ?>
                        ...
                        <li class="dropdown">
                             <a href=>VIEW INSURANCE INFORMATION<i class="fa fa-angle-down"></i></a>
                            <ul class="dropdown-menu">
