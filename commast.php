...
if(isset($_POST['submit']))
{
	...
	{
	$sqlrec = "INSERT INTO commission_master (insurance_scheme_id,agent_id,commission_amt,transaction_type,transaction_date,particulars,status) VALUES ('$_POST[ischeme]','$_POST[agent]',$_POST[camt]','$_POST[ttype]','$_POST[tdate]','$_POST[particulars]','$_POST[status]')";
	$qsqlrec = mysqli_query($con,$sqlrec);
	if(mysqli_affected_rows($con) == 1 )
	{
...
if(isset($_GET['editid']))
{
	$sqlrecedit = "SELECT * FROM commission_master WHERE commission_master_id='$_GET[editid]'";
...
<form method="post" name="contact" action="">
                        ...
                        <label for="Password">Insurance scheme:</label>
                         <select name="ischeme" class="validate-email required input_field" >
                          ...
                          <?php
						$sqlrecinsurplan = "SELECT * FROM insurance_scheme WHERE status='Active'";
