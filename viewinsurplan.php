...
if(isset($_GET['delid']))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		...
		echo "<script>window.location='viewinsurplan.php';</script>";
	}
}
...
?>
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                <h2>View Insurance Plan Records</h2>
                <p class="lead"></p>
              ...
              <thead>
				...
				while($rs = mysqli_fetch_array($qsqlrec))
				{
                	...
                	echo " <tr>
						  ...
						  <td>&nbsp;$rs[status]</td>
						  <td><a href='insurplan.php?editid=$rs[insurance_plan_id]' class='btn btn-info'  style='width: 100%;' >Edit</a> <a href='viewinsurplan.php?delid=$rs[insurance_plan_id]' onclick='return deleteconfirm()' class='btn btn-danger'  style='width: 100%;'>Delete</a></td>
						</tr>";
				}
				?>
              </table>
