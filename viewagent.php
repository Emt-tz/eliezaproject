...
if(isset($_GET['delid']))
{
	$sqlrec = "DELETE FROM agent where agent_id='$_GET[delid]'";
    ...
    while($rs = mysqli_fetch_array($qsqlrec))
    {
        echo " <tr>
			  ...
			  <td>&nbsp;$rs[Qualification]</td>
               <td>&nbsp;$rs[status]</td>
              <td><a href='agent.php?editid=$rs[agent_id]' class='btn btn-info' style='width: 100%' class='btn btn-info' >Edit</a>   <a href='viewagent.php?delid=$rs[agent_id]' onclick='return deleteconfirm()' class='btn btn-danger' style='width: 100%' class='btn btn-danger' >Delete</a></td>
            </tr>";
    }
    ?>
    </tbody>
