        ...
        <div class="container">
            ...
            <div class="row contact-wrap" > 
               ...
               <thead>
                ...
                <tbody>
                <?php		
				$sqlrec = "SELECT * FROM insurance_account inner join customer ON insurance_account.customer_id = customer.customer_id WHERE customer.agent_id='$_SESSION[agent_id]' ";
				$qsqlrec = mysqli_query($con,$sqlrec);
