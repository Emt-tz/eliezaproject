        ...
        <div class="row">
			...
			<div class="col-sm-6 col-md-4">
                <div class="media services-wrap wow fadeInDown">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">
                            <h3 class="media-heading"><a class="preview" href="custclaim.php"
                                    rel="prettyPhoto">Policy Claim</a></h3>
                            <p> </p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="media services-wrap wow fadeInDown">
                    ...
                    <div class="media-body">
                        <h3 class="media-heading">
                            <h3 class="media-heading"><a class="preview" href="customerchangepass.php"
                                    rel="prettyPhoto">Change Password</a></h3>
