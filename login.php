...
{
	$sqlrec = "UPDATE customer SET status='Active' WHERE customer_id='$_GET[customerid]' ";
...
if(isset($_POST['submit']))
{
		...
		$pwd = $_POST['password'];
	$sqlrec = "SELECT * FROM customer WHERE login_id='$_POST[loginid]'  && password='$pwd' && status='Active'";
	$var=mysqli_query($con,$sqlrec);	
...
<div align="center">
	...
	<!-- <tr><th><label for="author">User:</label></th><td>  <select class="form-control inputstl" id="user"
                                            name="user">
