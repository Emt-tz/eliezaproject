...
if($_SESSION['randomid']==$_POST['randomid'])
{
	if(isset($_POST['submit']))
	{
		...
		{
			$sqlrec = "INSERT INTO insurance_plan (insurance_type_id,insurance_scheme_id,policy_term_min,policy_term_max,min_age, max_age,sum_assured_min,sum_assured_max,profit_ratio,status) VALUES ('$_POST[itype]','$_POST[ischeme]','$_POST[mini]','$_POST[maxi]','$_POST[amin]','$_POST[amax]','$_POST[smin]','$_POST[smax]','$_POST[profit]','$_POST[status]')";
			$qsqlrec = mysqli_query($con,$sqlrec);
			if(mysqli_affected_rows($con) == 1 )
			{
...
if(isset($_GET['editid']))
{
	$sqlrecedit = "SELECT * FROM insurance_plan WHERE insurance_plan_id='$_GET[editid]'";
