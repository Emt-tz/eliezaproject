...
if($_SESSION['randomid']==$_POST['randomid'])
{
	...
	{
			$sqlrec = "UPDATE settings SET claim_deducation='$_POST[claimdeduction]',penalty_amt='$_POST[penaltyamt]' WHERE settings_id='1' ";
...
$sqlrecedit = "SELECT * FROM settings WHERE settings_id='1'";
